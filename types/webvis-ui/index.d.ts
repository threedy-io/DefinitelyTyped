...
declare namespace webvisUI {
    enum UISetting {
         ...
         * E.g.:
         *
         * https://my-domain.com/my-app.html?storeSpaceId=${SPACE_ID}
         * ${ORIGIN}/my-app.html?storeSpaceId=${SPACE_ID}
         * ${SELF}?storeSpaceId=${SPACE_ID}
         */
         ...
         * E.g.:
         *
         * https://my-domain.com/my-app.html?sharedSpaceId=${SPACE_ID}
         * ${ORIGIN}/my-app.html?sharedSpaceId=${SPACE_ID}
         * ${SELF}?sharedSpaceId=${SPACE_ID}
         */
    ...
    function requestDialog<T extends HTMLElement>(dialogName: string, triggeredBy: HTMLElement): T | null;
    interface EventMap {
        [key: string]: UINotificationEvent | UISettingChangedEvent;
